Menus["resurrect player"] = {
    ...
    "help\n"..color.White.."this person? it will cost you gold",
    buttons = {						
        { caption = "Patch them up.",
            destinations = {
                         ...
                         {
                          menuHelper.conditions.requireItem("gold_001", 500)
                         },
                         {
                          menuHelper.effects.removeItem("gold_001", 500),
...
Menus["Success"] = {
    text = "500 Gold has been taken and they have been resurrected.",
    buttons = {
        { caption = "Ok", destinations = nil }
    }
}